...
public class ManageController : Controller
{
    ...
    public async Task<IActionResult> SendVerificationEmail(IndexViewModel model)
    {
        if (!ModelState.IsValid)
        {
            //todo: SendVerificationEmail view is missing
    ...
    public IActionResult ShowRecoveryCodes()
    {
        ...
        //todo: ShowRecoveryCodes view is missing
        return Empty; //View(model);
    }
    ...
    public async Task<IActionResult> GenerateRecoveryCodes()
    {
        ...
        //todo: ShowRecoveryCodes view is missing
        return Empty; //View(nameof(ShowRecoveryCodes), model);
    }
    ...
    public async Task<IActionResult> GenerateRecoveryCodesWarning()
    {
        ...
        if (!user.TwoFactorEnabled)
        {
            ...
            //todo: ShowRecoveryCodes view is missing
            return Empty; //View(nameof(GenerateRecoveryCodesWarning));
    }
